...
public class OracleUriFunctions {
	...
	public int oracleAnsible(String schemaName, String schemaAction) throws Exception {
		...
		ProcessBuilder pb = new ProcessBuilder("/usr/local/bin/ansible-playbook",
				// "-s",
				// "/Users/dbgsm0/twork/oracle_saas/ansible/oracle_saas1/oracle_saas.yml",
				"-s", "/Users/dbgsm0/twork/oracle_saas/ansible/oracle_saas1/oracle_saas_forjava.yml", "-i",
				"/Users/dbgsm0/opt/ansible/hosts", "-u", "ansible", "-e", extraVarSchemaName, "-e",
	...
	public void oracleAnsibleVoid(String schemaName, String schemaAction) throws Exception {
		...
		ProcessBuilder pb = new ProcessBuilder("/usr/local/bin/ansible-playbook",
				// "-s",
				// "/Users/dbgsm0/twork/oracle_saas/ansible/oracle_saas1/oracle_saas.yml",
				"-s", "/Users/dbgsm0/twork/oracle_saas/ansible/oracle_saas1/oracle_saas.yml", "-i",
				"/Users/dbgsm0/opt/ansible/hosts", "-u", "ansible", "-e", extraVarSchemaName, "-e",
				extraVarSchemaAction);
