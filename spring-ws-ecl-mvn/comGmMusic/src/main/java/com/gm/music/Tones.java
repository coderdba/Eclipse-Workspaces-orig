...
public class Tones {
	...
	public void playNoteList (double[] notesHertz, int volume, float lengthSeconds) throws Exception {
	...
	private void play (double Hertz, int volume, float lengthSeconds) throws LineUnavailableException {
		/** Exception is thrown when line cannot be opened */
